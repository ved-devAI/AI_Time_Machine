...
OrbitCart Git repository, Git ingestion, an evidence timeline, a validated
GPT-5.6-in-Codex analysis artifact, and a visual Bug Origin Trace.
...
5. `app/server.py` exposes the timeline and investigation endpoints.
6. `frontend/` renders the timeline and a six-stage visual Bug Origin Trace.
